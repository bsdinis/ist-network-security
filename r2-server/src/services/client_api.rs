...
impl ClientApi for ClientApiService {
    ...
    async fn fetch_commit(&self, request: Request<FetchCommitRequest>) -> Result<Response<FetchCommitResponse>, Status> {
        eprintln!("not implemented: request was {:#?}", request);
        Err(Status::unimplemented("hold up, not yet"))
    }
    ...
    async fn edit_collaborators(&self, request: Request<EditCollaboratorsRequest>) -> Result<Response<EditCollaboratorsResponse>, Status> {
        eprintln!("not implemented: request was {:#?}", request);
        Err(Status::unimplemented("hold up, not yet"))
    }

    async fn squash(&self, request: Request<SquashRequest>) -> Result<Response<SquashResponse>, Status> {
        eprintln!("not implemented: request was {:#?}", request);
        Err(Status::unimplemented("hold up, not yet"))
    }

    async fn rollback(&self, request: Request<RollbackRequest>) -> Result<Response<RollbackRequest>, Status> {
        eprintln!("not implemented: request was {:#?}", request);
        Err(Status::unimplemented("hold up, not yet"))
    }
}
